...
public class Product {
    ...
    public String toString() {
        return "Product [productCode=" + getProductCode() + ", productName=" + getProductName() + ", price=" + getPrice() + ", registerDateTime="
                + getRegisterDateTime() + ", updateDateTime=" + getUpdateDateTime() + ", deleteDateTime=" + getDeleteDateTime() + "]";
    }
}
